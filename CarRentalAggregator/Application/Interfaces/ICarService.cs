...
namespace CarRentalAggregator.Application.Interfaces
{
    public interface ICarService
    {
        ...
        public Task<IEnumerable<CarDto?>> GetByEngineTypeAsync(EngineTypes engineType, CancellationToken cancellationToken);
        public Task<IEnumerable<CarDto?>> GetByPriceAsync(EngineTypes engineType, CancellationToken cancellationToken);
